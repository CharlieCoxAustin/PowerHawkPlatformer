class LevelOne extends Level
{
    ...
    create()
    {
        ...
        this.theBadGuyFactory.createBreedingBadGuy("chicken-01.png", 1, 2000, 300, 200, 200, this.player, this.theFireballFactory.fireballArray);
        //this.theBadGuyFactory.createFastBadGuy("chicken-01.png", 1, 1000, 500, 200, 200, this.player, this.theFireballFactory.fireballArray);
        //this.theBadGuyFactory.createFastBadGuy("chicken-01.png", 1, 3000, 600, 200, 200, this.player, this.theFireballFactory.fireballArray);
        //this.theBadGuyFactory.createFastBadGuy("chicken-01.png", 1, 4000, 200, 200, 200, this.player, this.theFireballFactory.fireballArray);
        //this.theBadGuyFactory.createFastBadGuy("chicken-01.png", 1, 5000, 100, 200, 200, this.player, this.theFireballFactory.fireballArray);
