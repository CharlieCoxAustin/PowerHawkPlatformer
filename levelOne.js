class LevelOne extends Level
{
    ...
    create()
    {
        ...
        this.theBadGuyFactory.createBadGuy("chicken-01.png", 1, 1000, 500, 200, 200, this.player, this.theFireballFactory.fireballArray);
        this.theBadGuyFactory.createBadGuy("chicken-01.png", 1, 3000, 600, 200, 200, this.player, this.theFireballFactory.fireballArray);
        this.theBadGuyFactory.createBadGuy("chicken-01.png", 1, 4000, 200, 200, 200, this.player, this.theFireballFactory.fireballArray);
        this.theBadGuyFactory.createBadGuy("chicken-01.png", 1, 5000, 100, 200, 200, this.player, this.theFireballFactory.fireballArray);
